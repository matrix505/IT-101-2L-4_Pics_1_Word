...
class Game(Tk,GameABC):
    ...
    __DATA_FILENAME = f"{os.path.dirname(__file__)}\\data\\progress_data.json"
    __DATA_IMAGE_NAME = f"{os.path.dirname(__file__)}\\data\\level_list.txt"
    ...
    def init_screen(self) -> None:
        ...
        self.coin_img = PhotoImage(file=f"{os.path.dirname(__file__)}\\data\\pics\\coin2.png").subsample(16)
        ...
        self.guess_img = PhotoImage(file=f"{os.path.dirname(__file__)}\\data"+r"\\pics\\{}.png".format(self.__imageNameList[self.imageNum]))
        ...
        self.hint_img = PhotoImage(file=f"{os.path.dirname(__file__)}\\data\\pics\\hint.png").subsample(10)
        ...
        self.next_img = PhotoImage(file=f"{os.path.dirname(__file__)}\\data\\pics\\next.png").subsample(25)
    ...
    def init_completed(self):
        ...
        self.celeb_img = PhotoImage(file=f'{os.path.dirname(__file__)}\\data\\pics\\celeb.png').subsample(5)
